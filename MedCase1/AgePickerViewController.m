...
- (IBAction)cancelButtonClicked:(UIBarButtonItem *)sender {
    [self.ageDelegate cancelButtonClicked];
}
- (IBAction)addButtonClicked:(UIBarButtonItem *)sender {
     //self.startAgeString = self.startAgeString ? self.startAgeString:[NSString stringWithFormat:@"%@",@(1)];
    //self.endAgeString = self.endAgeString ? self.endAgeString:[NSString stringWithFormat:@"%@",@(1)];
